...
**Tests**: Include test tasks whenever the feature changes repository state,
affects scheduling or prioritization, or introduces a new schema/config/prompt
contract. Treat those tests as mandatory even if the spec does not ask for them
explicitly.
...
- [ ] T010 Define autonomy boundaries and confirmation handling for each write
      path
- [ ] T011 Define repository-backed audit logging for user requests, assistant
      actions, and file mutations
...
- [ ] T014 [P] [US1] Audit/logging verification for [user journey] in
      tests/integration/test_[name]_audit.py
...
- [ ] T021 [US1] Update schema/config/prompt contracts touched by this story
...
- [ ] T024 [P] [US2] Audit/logging verification for [user journey] in
      tests/integration/test_[name]_audit.py
...
- [ ] T029 [US2] Update schema/config/prompt contracts touched by this story
...
- [ ] T032 [P] [US3] Audit/logging verification for [user journey] in
      tests/integration/test_[name]_audit.py
...
- [ ] T036 [US3] Update schema/config/prompt contracts touched by this story
...
- [ ] TXXX Review retention and audit log visibility against constitution
